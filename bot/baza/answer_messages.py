...
class message_texts():
    on = {
        ...
        'code_word_text': 'Придумайте и запомнтие кодовое слово. Будет '
                        + 'необходимо для удаления или редактирования ваших объектов.'
    }
    ...
    def aqidel():
        text = ('Гипотеза засыпанного русла.\n\n'
                ...
                + 'питавшие большую реку никто не отменял. '
                ...
                + 'по Каме, были удивлены местной красотой, что решили здесь '
                + 'обосноваться и вести торговлю. Тут у меня два вопроса. '
                + 'Официально на месте города всегда было поле и небольшие села. '
                ...
                + 'в 10 км от Касёва? Зачем здесь было строить торговый дом, '
                + 'коим являлось их поместье?\n\n'
                + 'Купцы могли обосноваться и вести торговлю на месте, только '
                ...
                + ' глубиной 2,5-3. А этого ли не достаточно для судоходства?\n\n'
                ...
                + 'Но на месте базы ничего нет.\n\n'
                + 'Всё это - материальные и документальные следы '
                + 'а так же мои умозаключения - прямо указывают '
                ...
                + 'Старое русло реки отмечено на карте 1779 года.')
